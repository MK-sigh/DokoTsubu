...
public class Register extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(!ValidationUtils.validateName(request, response, username, "/WEB-INF/jsp/registerView.jsp"))return;
        if(!ValidationUtils.validatePass(request, response, password, "/WEB-INF/jsp/registerView.jsp"))return;
